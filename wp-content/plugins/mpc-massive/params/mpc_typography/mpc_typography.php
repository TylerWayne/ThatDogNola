...
vc_add_shortcode_param( 'mpc_typography', 'mpc_typography_settings', MPC_MASSIVE_URL . '/assets/js/mpc-params.js' );
...
function mpc_get_typography_form() {
	...
	<div id="mpc_typography_form" class="mpc-typography-form">
		...
		<div class="mpc-form-element mpc-half">
			...
			<input class="mpc-typography-value" name="color" type="text" value="">
		</div>
