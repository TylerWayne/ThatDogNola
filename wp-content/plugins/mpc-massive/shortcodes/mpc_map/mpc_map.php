...
if ( ! class_exists( 'MPC_Map' ) ) {
	class MPC_Map {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_map-css', MPC_MASSIVE_URL . '/shortcodes/mpc_map/css/mpc_map.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_map-js', MPC_MASSIVE_URL . '/shortcodes/mpc_map/js/mpc_map' . MPC_MASSIVE_MIN . '.js', array( 'jquery', 'google-maps-api' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_template( $atts, $content = null ) {
			...
			$return = '<div data-id="' . $css_id . '" class="mpc-map-wrap' . $classes . '" ' . $animation . '>';
				if ( isset( $markers ) && $mpc_frontend ) {
					$return .= '<div class="mpc-markers"><span class="mpc-marker-title"><img src="' . MPC_MASSIVE_URL . '/assets/images/icons/mpc-google-maps.png' . '" />' . __( 'Map Markers' ) . '</span>' . $markers . '</div>';
				}
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'            => 'mpc_map',
				'class'           => '',
//				'icon'            => MPC_MASSIVE_URL . '/assets/images/icons/mpc-google-maps.png',
				'icon'            => 'mpc-shicon-map',
				'category'        => __( 'MPC', 'mpc' ),
