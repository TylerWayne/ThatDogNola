...
if ( ! class_exists( 'MPC_Carousel_Slider' ) ) {
	class MPC_Carousel_Slider {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_carousel_slider-css', MPC_MASSIVE_URL . '/shortcodes/mpc_carousel_slider/css/mpc_carousel_slider.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_carousel_slider-js', MPC_MASSIVE_URL . '/shortcodes/mpc_carousel_slider/js/mpc_carousel_slider' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
...
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-carousel-slider.png',
