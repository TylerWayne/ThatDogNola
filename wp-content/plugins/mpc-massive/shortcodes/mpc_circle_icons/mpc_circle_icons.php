...
if ( ! class_exists( 'MPC_Circle_Icons' ) ) {
	class MPC_Circle_Icons {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_circle_icons-css', MPC_MASSIVE_URL . '/shortcodes/mpc_circle_icons/css/mpc_circle_icons.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_circle_icons-js', MPC_MASSIVE_URL . '/shortcodes/mpc_circle_icons/js/mpc_circle_icons' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
