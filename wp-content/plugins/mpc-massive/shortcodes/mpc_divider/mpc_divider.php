...
if ( !class_exists( 'MPC_divider' ) ) {
	class MPC_Divider {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_divider-css', MPC_MASSIVE_URL . '/shortcodes/mpc_divider/css/mpc_divider.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_divider-js', MPC_MASSIVE_URL . '/shortcodes/mpc_divider/js/mpc_divider' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_divider',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-divider.png',
