...
//				'icon'                      => MPC_MASSIVE_URL . '/assets/images/icons/mpc-flipbox.png',
...
if ( ! class_exists( 'MPC_Flipbox' ) ) {
	class MPC_Flipbox {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_flipbox-css', MPC_MASSIVE_URL . '/shortcodes/mpc_flipbox/css/mpc_flipbox.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_flipbox-js', MPC_MASSIVE_URL . '/shortcodes/mpc_flipbox/js/mpc_flipbox' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
