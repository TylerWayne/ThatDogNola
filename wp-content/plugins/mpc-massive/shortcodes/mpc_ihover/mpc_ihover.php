...
if ( ! class_exists( 'MPC_iHover' ) ) {
	class MPC_iHover {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_ihover-css', MPC_MASSIVE_URL . '/shortcodes/mpc_ihover/css/mpc_ihover.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_ihover-js', MPC_MASSIVE_URL . '/shortcodes/mpc_ihover/js/mpc_ihover' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}

		/* Return shortcode markup for display */
		function shortcode_template( $atts, $content = null ) {
			/* Enqueues */
			wp_enqueue_style( 'mpc-massive-ihover-css', MPC_MASSIVE_URL . '/assets/css/libs/ihover.min.css' );
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'                    => 'mpc_ihover',
				'class'                   => '',
//				'icon'                    => MPC_MASSIVE_URL . '/assets/images/icons/mpc-ihover.png',
