...
if ( ! class_exists( 'MPC_Pricing_Box' ) ) {
	class MPC_Pricing_Box {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_pricing_box-css', MPC_MASSIVE_URL . '/shortcodes/mpc_pricing_box/css/mpc_pricing_box.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_pricing_box-js', MPC_MASSIVE_URL . '/shortcodes/mpc_pricing_box/js/mpc_pricing_box' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
