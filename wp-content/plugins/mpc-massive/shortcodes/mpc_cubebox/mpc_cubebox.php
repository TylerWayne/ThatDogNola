...
//				'icon'                      => MPC_MASSIVE_URL . '/assets/images/icons/mpc-cubebox.png',
...
if ( ! class_exists( 'MPC_Cubebox' ) ) {
	class MPC_Cubebox {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_cubebox-css', MPC_MASSIVE_URL . '/shortcodes/mpc_cubebox/css/mpc_cubebox.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_cubebox-js', MPC_MASSIVE_URL . '/shortcodes/mpc_cubebox/js/mpc_cubebox' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
