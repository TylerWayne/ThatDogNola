...
if ( ! class_exists( 'MPC_Modal' ) ) {
	...
	class MPC_Modal {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_modal-css', MPC_MASSIVE_URL . '/shortcodes/mpc_modal/css/mpc_modal.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_modal-js', MPC_MASSIVE_URL . '/shortcodes/mpc_modal/js/mpc_modal' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			$base = array(
				...
				array(
					...
					'admin_label'      => true,
					'tooltip'          => __( 'Paste this ID to any shortcode as link URL. This will show this modal after user clicks on the shortcode.', 'mpc' ),
//					'value'            => '',
			...
			return array(
				...
				'base'                    => 'mpc_modal',
				'class'                   => '',
//				'icon'                    => MPC_MASSIVE_URL . '/assets/images/icons/mpc-modal.png',
