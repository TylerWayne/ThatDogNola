...
if ( ! class_exists( 'MPC_iHover_Item' ) ) {
	class MPC_iHover_Item {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_ihover_item-css', MPC_MASSIVE_URL . '/shortcodes/mpc_ihover_item/css/mpc_ihover_item.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_ihover_item-js', MPC_MASSIVE_URL . '/shortcodes/mpc_ihover_item/js/mpc_ihover_item' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
