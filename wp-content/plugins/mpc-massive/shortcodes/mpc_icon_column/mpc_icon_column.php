...
if ( ! class_exists( 'MPC_Icon_Column' ) ) {
	class MPC_Icon_Column {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_icon_column-css', MPC_MASSIVE_URL . '/shortcodes/mpc_icon_column/css/mpc_icon_column.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_icon_column-js', MPC_MASSIVE_URL . '/shortcodes/mpc_icon_column/js/mpc_icon_column' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-icon-column.png',
