...
if ( ! class_exists( 'MPC_Counter' ) ) {
	class MPC_Counter {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_counter-css', MPC_MASSIVE_URL . '/shortcodes/mpc_counter/css/mpc_counter.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_counter-js', MPC_MASSIVE_URL . '/shortcodes/mpc_counter/js/mpc_counter' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_template( $atts, $description = null ) {
			/* Enqueues */
			wp_enqueue_script( 'mpc-massive-countup-js', MPC_MASSIVE_URL . '/assets/js/libs/countUp.min.js', array(), '', true );
			...
			$duration      = $atts[ 'duration' ] != '' ? (int) esc_attr( $atts[ 'duration' ] ) : 500;
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_counter',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-counter.png',
