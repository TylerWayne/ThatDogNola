...
if ( ! class_exists( 'MPC_Carousel_Posts' ) ) {
	class MPC_Carousel_Posts {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_carousel_posts-css', MPC_MASSIVE_URL . '/shortcodes/mpc_carousel_posts/css/mpc_carousel_posts.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_carousel_posts-js', MPC_MASSIVE_URL . '/shortcodes/mpc_carousel_posts/js/mpc_carousel_posts' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_template( $atts, $content = null ) {
			...
			/* Build Query */
			$data_query = $this->get_posts( $slider_atts );
			...
			$MPC_Single_Post->query = &$data_query;
...
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-carousel-posts.png',
