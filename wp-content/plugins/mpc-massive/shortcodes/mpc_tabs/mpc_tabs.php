...
if ( ! class_exists( 'MPC_Tabs' ) ) {
	...
	class MPC_Tabs {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_tabs-css', MPC_MASSIVE_URL . '/shortcodes/mpc_tabs/css/mpc_tabs.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_tabs-js', MPC_MASSIVE_URL . '/shortcodes/mpc_tabs/js/mpc_tabs' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
...
//				'icon'                    => MPC_MASSIVE_URL . '/assets/images/icons/mpc-tabs.png',
