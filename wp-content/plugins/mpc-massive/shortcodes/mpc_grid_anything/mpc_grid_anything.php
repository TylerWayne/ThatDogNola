...
if ( ! class_exists( 'MPC_Grid_Anything' ) ) {
	class MPC_Grid_Anything {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_grid_anything-css', MPC_MASSIVE_URL . '/shortcodes/mpc_grid_anything/css/mpc_grid_anything.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_grid_anything-js', MPC_MASSIVE_URL . '/shortcodes/mpc_grid_anything/js/mpc_grid_anything' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
...
//				'icon'                    => MPC_MASSIVE_URL . '/assets/images/icons/mpc-grid-anything.png',
