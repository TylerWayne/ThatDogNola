...
if ( ! class_exists( 'MPC_Callout' ) ) {
	class MPC_Callout {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_callout-css', MPC_MASSIVE_URL . '/shortcodes/mpc_callout/css/mpc_callout.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_callout-js', MPC_MASSIVE_URL . '/shortcodes/mpc_callout/js/mpc_callout' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_styles( $styles ) {
			...
			// Heading
			$inner_styles = array();
			if ( $styles[ 'content_width' ] ) { $inner_styles[] = 'max-width: ' . $styles[ 'content_width' ] . ';'; }
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_callout',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-call-out.png',
