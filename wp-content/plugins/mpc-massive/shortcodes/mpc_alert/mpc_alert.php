...
if ( ! class_exists( 'MPC_Alert' ) ) {
	...
	class MPC_Alert {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_alert-css', MPC_MASSIVE_URL . '/shortcodes/mpc_alert/css/mpc_alert.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_alert-js', MPC_MASSIVE_URL . '/shortcodes/mpc_alert/js/mpc_alert' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
