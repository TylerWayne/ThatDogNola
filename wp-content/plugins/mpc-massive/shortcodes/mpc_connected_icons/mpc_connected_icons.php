...
if ( ! class_exists( 'MPC_Connected_Icons' ) ) {
	class MPC_Connected_Icons {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_connected_icons-css', MPC_MASSIVE_URL . '/shortcodes/mpc_connected_icons/css/mpc_connected_icons.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_connected_icons-js', MPC_MASSIVE_URL . '/shortcodes/mpc_connected_icons/js/mpc_connected_icons' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
...
//				'icon'                    => MPC_MASSIVE_URL . '/assets/images/icons/mpc-connected-icon-column.png',
