...
if ( ! class_exists( 'MPC_Button' ) ) {
	class MPC_Button {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_button-css', MPC_MASSIVE_URL . '/shortcodes/mpc_button/css/mpc_button.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_button-js', MPC_MASSIVE_URL . '/shortcodes/mpc_button/js/mpc_button' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_button',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-button.png',
