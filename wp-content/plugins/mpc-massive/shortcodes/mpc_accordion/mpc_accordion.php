...
//				'icon'            => MPC_MASSIVE_URL . '/assets/images/icons/mpc-accordion.png',
...
if ( ! class_exists( 'MPC_Accordion' ) ) {
	...
	class MPC_Accordion {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_accordion-css', MPC_MASSIVE_URL . '/shortcodes/mpc_accordion/css/mpc_accordion.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_accordion-js', MPC_MASSIVE_URL . '/shortcodes/mpc_accordion/js/mpc_accordion'  . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
