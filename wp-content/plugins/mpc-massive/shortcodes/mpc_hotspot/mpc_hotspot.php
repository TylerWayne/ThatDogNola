...
if ( ! class_exists( 'MPC_Hotspot' ) ) {
	class MPC_Hotspot {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_hotspot-css', MPC_MASSIVE_URL . '/shortcodes/mpc_hotspot/css/mpc_hotspot.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_hotspot-js', MPC_MASSIVE_URL . '/shortcodes/mpc_hotspot/js/mpc_hotspot' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
