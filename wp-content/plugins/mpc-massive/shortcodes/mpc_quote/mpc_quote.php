...
if ( ! class_exists( 'MPC_Quote' ) ) {
	class MPC_Quote {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_quote-css', MPC_MASSIVE_URL . '/shortcodes/mpc_quote/css/mpc_quote.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_quote-js', MPC_MASSIVE_URL . '/shortcodes/mpc_quote/js/mpc_quote' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_quote',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-quote.png',
