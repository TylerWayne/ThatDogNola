...
if ( ! class_exists( 'MPC_Testimonial' ) ) {
	class MPC_Testimonial {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_testimonial-css', MPC_MASSIVE_URL . '/shortcodes/mpc_testimonial/css/mpc_testimonial.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_testimonial-js', MPC_MASSIVE_URL . '/shortcodes/mpc_testimonial/js/mpc_testimonial' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-testimonials.png',
