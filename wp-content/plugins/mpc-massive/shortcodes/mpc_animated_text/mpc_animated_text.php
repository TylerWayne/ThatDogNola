...
if ( ! class_exists( 'MPC_Animated_Text' ) ) {
	class MPC_Animated_Text {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_animated_text-css', MPC_MASSIVE_URL . '/shortcodes/mpc_animated_text/css/mpc_animated_text.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_animated_text-js', MPC_MASSIVE_URL . '/shortcodes/mpc_animated_text/js/mpc_animated_text' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-animated-text.png',
