...
if ( !class_exists( 'MPC_Pricing_Legend' ) ) {
	class MPC_Pricing_Legend {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_pricing_legend-css', MPC_MASSIVE_URL . '/shortcodes/mpc_pricing_legend/css/mpc_pricing_legend.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_pricing_legend-js', MPC_MASSIVE_URL . '/shortcodes/mpc_pricing_legend/js/mpc_pricing_legend' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
...
//				'icon'            => MPC_MASSIVE_URL . '/assets/images/icons/mpc-pricing-box.png',
