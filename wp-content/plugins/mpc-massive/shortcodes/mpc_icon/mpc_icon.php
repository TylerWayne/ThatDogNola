...
if ( ! class_exists( 'MPC_Icon' ) ) {
	class MPC_Icon {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_icon-css', MPC_MASSIVE_URL . '/shortcodes/mpc_icon/css/mpc_icon.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_icon-js', MPC_MASSIVE_URL . '/shortcodes/mpc_icon/js/mpc_icon' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_icon',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-icon.png',
