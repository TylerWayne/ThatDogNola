...
if ( ! class_exists( 'MPC_Ribbon' ) ) {
	class MPC_Ribbon {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_ribbon-css', MPC_MASSIVE_URL . '/shortcodes/mpc_ribbon/css/mpc_ribbon.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_ribbon-js', MPC_MASSIVE_URL . '/shortcodes/mpc_ribbon/js/mpc_ribbon' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_ribbon',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-ribbon.png',
