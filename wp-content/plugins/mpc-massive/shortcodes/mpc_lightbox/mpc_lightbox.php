...
if ( ! class_exists( 'MPC_Lightbox' ) ) {
	class MPC_Lightbox {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_lightbox-css', MPC_MASSIVE_URL . '/shortcodes/mpc_lightbox/css/mpc_lightbox.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_lightbox-js', MPC_MASSIVE_URL . '/shortcodes/mpc_lightbox/js/mpc_lightbox' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_lightbox',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-lightbox.png',
