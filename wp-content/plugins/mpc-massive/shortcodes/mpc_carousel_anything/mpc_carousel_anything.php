...
if ( ! class_exists( 'MPC_Carousel_Anything' ) ) {
	class MPC_Carousel_Anything {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_carousel_anything-css', MPC_MASSIVE_URL . '/shortcodes/mpc_carousel_anything/css/mpc_carousel_anything.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_carousel_anything-js', MPC_MASSIVE_URL . '/shortcodes/mpc_carousel_anything/js/mpc_carousel_anything' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			$rows_cols = MPC_Snippets::vc_rows_cols( array( 'rows' => false, 'cols' => array( 'max' => 8 ) ) );
			...
			return array(
				...
				'is_container'            => true,
				'as_parent'               => array( 'only' => 'mpc_alert,mpc_button,mpc_cubebox,mpc_flipbox,mpc_icon,mpc_ihover,mpc_map,mpc_quote,vc_single_image,vc_video,vc_column_text,mpc_callout,mpc_chart,mpc_counter,mpc_icon_column' ),
				'content_element'         => true,
				'show_settings_on_create' => true,
//				'icon'                    => MPC_MASSIVE_URL . '/assets/images/icons/mpc-carousel-anything.png',
