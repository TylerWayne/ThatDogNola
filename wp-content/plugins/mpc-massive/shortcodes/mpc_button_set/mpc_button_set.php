...
if ( ! class_exists( 'MPC_Button_Set' ) ) {
	class MPC_Button_Set {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_button_set-css', MPC_MASSIVE_URL . '/shortcodes/mpc_button_set/css/mpc_button_set.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_button_set-js', MPC_MASSIVE_URL . '/shortcodes/mpc_button_set/js/mpc_button_set' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
