...
if ( ! class_exists( 'MPC_Progress' ) ) {
	class MPC_Progress {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_progress-css', MPC_MASSIVE_URL . '/shortcodes/mpc_progress/css/mpc_progress.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_progress-js', MPC_MASSIVE_URL . '/shortcodes/mpc_progress/js/mpc_progress' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
		...
		function shortcode_map() {
			...
			return array(
				...
				'base'        => 'mpc_progress',
				'class'       => '',
//				'icon'        => MPC_MASSIVE_URL . '/assets/images/icons/mpc-progress-bar.png',
