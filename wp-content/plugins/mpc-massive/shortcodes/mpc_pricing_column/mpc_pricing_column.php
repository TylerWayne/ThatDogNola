...
if ( !class_exists( 'MPC_Pricing_Column' ) ) {
	class MPC_Pricing_Column {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_pricing_column-css', MPC_MASSIVE_URL . '/shortcodes/mpc_pricing_column/css/mpc_pricing_column.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_pricing_column-js', MPC_MASSIVE_URL . '/shortcodes/mpc_pricing_column/js/mpc_pricing_column' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
